...
<head>
    ...
    <link rel="icon" href="/wp-content/themes/dimensional-dental/images/favicon.png">
    <title>
...
<body <?php body_class(); ?>>
    ...
    <div class="head-wrap container row twelve">
        ...
        <div class="logo col-sd-12 col-dd-3">
            <a href="https://www.dimensionaldental.com/"><img src="/wp-content/themes/dimensional-dental/images/logo.png" alt="Dimensional Dental Logo" /></a>
        </div>
